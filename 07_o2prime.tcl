...
set outfile [open "residue_unique_eachvisit_MGw2.5_o2prime_4.8us_ev1ns_MG31-35.dat" w]

# loop over all frames
for {set i 1} {$i < $nf} {incr i} {
	for {set j 31} {$j < 36} {incr j} {
               set sel [atomselect top "nucleic and name O2' and within 2.5 of (name MG and resid $j)" frame $i]
